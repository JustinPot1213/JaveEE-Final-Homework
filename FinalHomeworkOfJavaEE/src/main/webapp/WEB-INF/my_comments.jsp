    ...
    <div class="comments">
        ...
        <div class="comment-wrap" style="word-wrap: break-word;word-break: break-all;overflow: hidden;">
            <div class="comment-block">
                <h3>评论 <a id="course_name" onclick="gotoDetail(${ comment.blog.id })" >
                    ${ comment.blog.header }</a></h3>
                ...
                <p class="comment-text">回复@${ comment.toComment.user.name }:${ comment.text }</p>
                </c:if>
                    ...
                    <div class="col-md-6">
                        <nav aria-label="Page navigation" class="pull-right">
                            <ul class="pagination" style="margin: 0px;">
                                ...
                                <c:if test="${pageInfo.pages != 0}">
                                    <li><a  href="${pageContext.request.contextPath}/my_comments?pageNo=1">首</a>
                                    </li>
                                    ...
                                    <c:if test="${pageInfo.pageNum!=1}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/my_comments?pageNo=${pageInfo.prePage}" aria-label="Previous" class="prePage">
                                                <span aria-hidden="true">上一页</span>
                                            </a>
                                        </li>
                                    </c:if>
                                    ...
                                    <c:forEach items="${pageInfo.navigatepageNums}" step="1" var="itemPage">
                                        <c:if test="${pageInfo.pageNum == itemPage}">
                                            <li class="active">
                                                <a href="${pageContext.request.contextPath}/my_comments?pageNo=${itemPage}">${itemPage}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${pageInfo.pageNum != itemPage}">
                                            <li>
                                    ...
                                    <c:if test="${pageInfo.pageNum != pageInfo.pages}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/my_comments?pageNo=${pageInfo.nextPage}" aria-label="Next" class="nextPage">
                                                <span aria-hidden="true">下一页</span>
                                            </a>
                                        </li>
                                    </c:if>
                                    <li><a
                                            href="${pageContext.request.contextPath}/my_comments?pageNo=${pageInfo.pages}">尾</a>
                                    </li>
                                </c:if>
                            </ul>
                        </nav>
